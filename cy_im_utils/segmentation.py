...
class bivariate_segmentation:
    ...
    def compute_histogram(self,
        ...
        Args:
        -----
            down_sampling: int -> this makes the computation run fatser and
                           down-samples the flattened array by this interval
        ...
        -------------
            instantiates:
                self.x_coords : array-like - x_coordinates of bins
                self.y_coords : array-like - y_coordinates of bins
                self.counts : 2d array - histogram values
        """
    ...
    def plot_segmented_frame(self,
        ...
        axis...
        Note phases can be passed as an argument to override the stateful
        phases
        """
        if phases is None:
            phases = self.phases
