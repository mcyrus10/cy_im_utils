...
def peak_signal_noise_ratio_GPU(image_ref: cp.array,
                                image_test: cp.array,
                                data_range=None):
    """
    """
...
def structural_similarity_GPU(im1: cp.array,
                              ...
                              **kwargs):
    """
    THIS IS TRANSLATED FROM skimage.metrics.structural_similarity source code,
    I removed some of the functionality (Gaussian_weightsa)

    This is inteded to run a batch of images, not to calculate the ssim of all
    the images together
...
def mean_squared_error_GPU(imstack_0: cp.array, imstack_1: cp.array):
    """
    Ultra basic
    """
